          ...
          <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
            ...
            <div className="bg-[#1a1a2e] border border-[#2a2a4e] rounded-2xl p-6 sm:p-8">
              ...
              <div className="flex items-start sm:items-center gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-600 rounded-full flex items-center justify-center shrink-0">
            ...
            <div className="bg-[#1a1a2e] border border-[#2a2a4e] rounded-2xl p-6 sm:p-8">
              ...
              <Link
                ...
                className="flex items-center gap-3 p-3 sm:p-4 bg-[#0f0f1e] border border-[#2a2a4e] rounded-lg hover:border-purple-500 hover:bg-purple-900/20 transition-all duration-200 group"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:text-purple-400 transition-colors" fill="currentColor" viewBox="0 0 20 20">
